              ...
              {[
                {
                  ...
                  body: 'Этот контент предназначен только для обмена отраслевым опытом. Платформа не несет ответственности за достоверность и точность любых данных из сторонних источников, приведенных в этом контенте. Контент не является руководством или обязательным требованием для стримеров.',
                },
                ...
                { label: '✅ Успех', color: 'green', icon: '✅', title: '', body: 'Хороший результат / лучшая практика.' },
                {
                  ...
                  icon: '⚠️',
                  title: 'Внимание',
                  body: 'Авторы не знают, как правильно общаться со своими зрителями? По каким критериям авторы могут узнать о зрителе? Авторы не хотят активно взаимодействовать с незнакомыми зрителями? Авторы слишком заняты, чтобы поприветствовать всех зрителей?... Как авторам следует взаимодействовать со зрителями?',
                },
